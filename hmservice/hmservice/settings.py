"""
Django settings for hmservice project.
...
SECRET_KEY = 'v_gan!l*3j17!xxu$-cgy1v9p&wsf&i44^jgo*4%9*w$r6f+23'
...
WSGI_APPLICATION = 'hmservice.wsgi.application'
